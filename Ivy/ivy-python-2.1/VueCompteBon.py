...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.boutonsOperateurs[4] = Button(self, text="=",command=self.addOp())
        self.boutonsOperateurs[4].grid(row = 5,column = 9,columnspan = 2, sticky = E+W)
        self.boutonsOperateurs[5] = Button(self, text="C",command=self.addOp())
        ...
        self.labelB = Label(self,text="A")
        self.labelB.grid(row = 2,column = 2,columnspan = 2, sticky = E+W)
        self.labelOp = Label(self,text="op")
        self.labelOp.grid(row = 2,column = 4,columnspan = 2, sticky = E+W)
        self.labelN = Label(self,text="B")
        self.labelN.grid(row = 2,column = 6,columnspan = 2, sticky = E+W)
